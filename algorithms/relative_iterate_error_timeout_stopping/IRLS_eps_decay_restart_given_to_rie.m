%% This is a version of IRLS algorithm with restarts for square-root LASSO which is based Sherman-Morrison-Woodbury formula.
...
function [x,time] = IRLS_eps_decay_restart_given_to_rie(A,U,Sigma,b,lambda,eps0,x0,Nlsp,tol,N_it,decay,s,solver, threshold, timeout)
% Initialization
