...
writetable(results_err,'eps_err_restart.csv','Delimiter',' ')

results_time = [eps_range.' avg_time.'];
results_time = array2table(results_time,'VariableNames',labels);
writetable(results_time,'eps_time_restart.csv','Delimiter',' ')

results_ratio = [eps_range.' avg_ratios.'];
results_ratio = array2table(results_ratio,'VariableNames',labels);
writetable(results_ratio,'eps_ratio_restart.csv','Delimiter',' ')

results_ratio = [eps_range.' avg_ratio2s.'];
results_ratio = array2table(results_ratio,'VariableNames',labels);
writetable(results_ratio,'eps_ratio2s_restart.csv','Delimiter',' ')
