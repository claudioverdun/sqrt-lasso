...
writetable(results_err,'lambda_err_restart_5.csv','Delimiter',' ')

results_time = [Lmult.' avg_time.'];
results_time = array2table(results_time,'VariableNames',labels);
writetable(results_time,'lambda_time_restart_5.csv','Delimiter',' ')

results_ratio = [Lmult.' avg_ratios.'];
results_ratio = array2table(results_ratio,'VariableNames',labels);
writetable(results_ratio,'lambda_ratio_restart_5.csv','Delimiter',' ')

results_ratio = [Lmult.' avg_ratio2s.'];
results_ratio = array2table(results_ratio,'VariableNames',labels);
writetable(results_ratio,'lambda_ratio2s_restart_5.csv','Delimiter',' ')
