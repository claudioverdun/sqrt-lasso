...
ER = readtable('lambda_err_restart_5.csv','Delimiter',' ');
...
writetable(ER,'lambda_err_restart_5.csv','Delimiter',' ')
% 
TI = readtable('lambda_time_restart_5.csv','Delimiter',' ');
figure
...
writetable(TI,'lambda_time_restart_5.csv','Delimiter',' ')

SFR = readtable('lambda_ratio_restart_5.csv','Delimiter',' ');
figure
...
writetable(SFR,'lambda_ratio_restart_5.csv','Delimiter',' ')

SFR2 = readtable('lambda_ratio2s_restart_5.csv','Delimiter',' ');
figure
...
writetable(SFR2,'lambda_ratio2s_restart_5.csv','Delimiter',' ')
