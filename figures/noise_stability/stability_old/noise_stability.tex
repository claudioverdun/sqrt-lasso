...
\pgfplotstableread[col sep=space]{noise_stab_err.csv}{\rat}
\begin{axis}[ 
cycle list/Dark2,
...
\addplot table[x=snr, y=ITEM]{\rat};
\addplot table[x=snr, y=prox_grad]{\rat};
\addplot table[x=snr, y=prox_newton]{\rat};
\addplot table[x=snr, y=concomitant]{\rat};
\addplot table[x=snr, y=irls_sqrt]{\rat};
\addplot table[x=snr, y=irls_sigma]{\rat};
...
\begin{tikzpicture}[scale=0.8]
\pgfplotstableread[col sep=space]{noise_stab_time.csv}{\rat}
\begin{axis}[ 
cycle list/Dark2,
cycle from colormap manual style,
%width = 100mm,
...
mark size=1.0pt,
%legend style={at={(1.05,0.95)},anchor= north west ,font=\fontsize{8}{8}\selectfont},
legend style={at={(0.02,0.98)},anchor= north west ,font=\fontsize{8}{8}\selectfont},
legend cell align={left},
legend columns=1
]
\addplot table[x=snr, y=ITEM]{\rat};
...
\begin{tikzpicture}[scale=0.8]
\pgfplotstableread[col sep=space]{noise_stab_ratio.csv}{\rat}
\begin{axis}[ 
cycle list/Dark2,
cycle from colormap manual style,
%width = 100mm,
...
\begin{tikzpicture}[scale=0.8]
\pgfplotstableread[col sep=space]{noise_stab_ratio2s.csv}{\rat}
\begin{axis}[ 
cycle list/Dark2,
cycle from colormap manual style,
%width = 100mm,
