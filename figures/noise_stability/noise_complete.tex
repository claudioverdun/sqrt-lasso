...
\addplot table[x=snr, y=irls_sqrt]{\timesm};
\addplot table[x=snr, y=irls_sigma]{\timesm};
\addplot table[x=snr, y=irls_sqrt_restart]{\timesm};
%    
...
\addplot table[x=snr, y=irls_sqrt]{\time};
\addplot table[x=snr, y=irls_sigma]{\time};
\addplot table[x=snr, y=irls_sqrt_restart]{\time};
%
\nextgroupplot[
            %ymode=log,
    		 %xmode = log,
