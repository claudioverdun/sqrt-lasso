...
ER = readtable('noise_stab_1_err.csv','Delimiter',' ');
 
figure
loglog(SNR_level, [ER.irls_sigma avg_error(6,:).'])
...
writetable(ER,'noise_stab_1_err.csv','Delimiter',' ')
% 
TI = readtable('noise_stab_1_time.csv','Delimiter',' ');
figure
loglog(SNR_level, [TI.irls_sigma avg_time(6,:).'])
title('Runtime')
legend({'old sigma','new sigma'})
% 
TI.irls_sigma = avg_time(6,:).';
writetable(TI,'noise_stab_1_time.csv','Delimiter',' ')

SFR = readtable('noise_stab_1_ratio.csv','Delimiter',' ');
figure
semilogx(SNR_level,[SFR.irls_sigma avg_ratios(6,:).'])
title('Missing support percentage')
legend({'old sigma','new sigma'})
% 
SFR.irls_sigma = avg_ratios(6,:).';
writetable(SFR,'noise_stab_1_ratio.csv','Delimiter',' ')

SFR2 = readtable('noise_stab_1_ratio2s.csv','Delimiter',' ');
figure
semilogx(SNR_level,[SFR2.irls_sigma avg_ratio2s(6,:).'])
title('Missing support percentage (2s)')
legend({'old sigma','new sigma'})
% 
SFR2.irls_sigma = avg_ratio2s(6,:).';
writetable(SFR2,'noise_stab_1_ratio2s.csv','Delimiter',' ')
