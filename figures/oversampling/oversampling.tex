...
\addplot table[x=m, y=irls_sqrt_restart]{\rat};
\legend{
ITEM,
Proximal Gradient,
Proximal Newton,
...
\begin{tikzpicture}[scale=0.8]
\pgfplotstableread[col sep=space]{oversampling_01_err.csv}{\rat}
\begin{axis}[ 
cycle list/Dark2,
cycle from colormap manual style,
grid=both,
...
\begin{tikzpicture}[scale=0.8]
\pgfplotstableread[col sep=space]{oversampling_01_time.csv}{\rat}
\begin{axis}[ 
cycle list/Dark2,
cycle from colormap manual style,
grid=both,
...
%\pgfplotsset{compat=1.5}
\begin{tikzpicture}[scale=0.8]
\pgfplotstableread[col sep=space]{oversampling_01_ratio.csv}{\rat}
\begin{axis}[ 
cycle list/Dark2,
cycle from colormap manual style,
grid=both,
...
mark size=1.0pt,
%legend style={at={(1.05,0.95)},anchor= north west ,font=\fontsize{8}{8}\selectfont},
legend style={at={(0.98,0.7)},anchor= north east ,font=\fontsize{8}{8}\selectfont},
legend cell align={left},
legend columns=1
]
\addplot table[x=m, y=ITEM]{\rat};
