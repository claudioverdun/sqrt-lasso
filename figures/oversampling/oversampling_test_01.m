...
%         b = b + sigma*randn(size(b)); 
        ...
        [x_7, t_7] = proximal_newton_to(A,b,0.0,lambda,x0,1000,1000, x, threshold, timeout);
        times(7,si,t) = t_7;
...
legend({'high(-3)','med(-6)','small(-9)','restrat+high(-3)','restart+med(-6)','restart+small(-9)','prox newton'})
