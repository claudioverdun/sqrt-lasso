...
ER = readtable('oversampling_err.csv','Delimiter',' ');
...
% writetable(ER,'oversampling_err.csv','Delimiter',' ')
% % % 
TI = readtable('oversampling_time.csv','Delimiter',' ');
figure
...
% writetable(TI,'oversampling_time.csv','Delimiter',' ')

SFR = readtable('oversampling_ratio.csv','Delimiter',' ');
figure
...
% writetable(SFR,'oversampling_ratio.csv','Delimiter',' ')

SFR2 = readtable('oversampling_ratio2.csv','Delimiter',' ');
figure
...
% writetable(SFR2,'oversampling_ratio2.csv','Delimiter',' ')
% % 
